...
export function ImportarContatos({
  ...
  return (
    <section className="app-card p-6">
      ...
      {estado.erro && (
        <p className="mt-4 rounded-lg border border-rose-400/25 bg-rose-400/[0.07] px-3.5 py-2.5 text-[13px] leading-5 text-perigo">
          {estado.erro}
        </p>
      )}
        ...
        <div className="mt-4 rounded-lg border border-emerald-400/25 bg-emerald-400/[0.06] px-3.5 py-2.5">
          ...
          {estado.pendentes && estado.pendentes.length > 0 && (
            <details className="mt-2.5">
              <summary className="cursor-pointer text-[12.5px] text-aviso">
              ...
              <ul className="mt-2 max-h-56 space-y-1 overflow-auto font-mono text-[12px] text-muted">
