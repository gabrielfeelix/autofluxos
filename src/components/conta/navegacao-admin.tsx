 ...
 *
 * **Um item por tela que existe, e só.** O desenho da §2.2 do PLANO-SISTEMA
 * lista também `Plataforma`, e essa tela não existe. A regra do próprio plano
 * vale aqui: item de menu para tela que não existe é promessa que a interface
 * faz e o produto não cumpre. `Alertas` entrou porque a tela passou a existir,
 * é o `Saúde` do plano com o nome do que ela mostra, e `Consumo` entrou pelo
 * mesmo motivo quando a medição da 0066 ganhou tela.
 *
...
const ITENS = [
  ...
  { href: '/admin/consumo', rotulo: 'Consumo' },
