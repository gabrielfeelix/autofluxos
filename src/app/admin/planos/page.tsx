...
export default async function Planos() {
  ...
  return (
    <TelaDaAdministracao titulo="Planos" descricao="Preço, limite de conversas, números e o que cada plano libera. A troca de plano de uma organização é na aba Plano dela, ou em Pedidos de plano.">
      {!editavel && (
