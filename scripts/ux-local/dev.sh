#!/bin/bash
# Sobe o painel na porta 3100 contra o Supabase LOCAL, nunca contra produção.
#
...
export BETTER_AUTH_SECRET=better-auth-de-teste-local-sem-valor-xxxxxxxx BETTER_AUTH_URL=http://localhost:3100
