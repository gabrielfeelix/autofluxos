...
Status: inventário e revisão estática encerrados. Base local de referência: commit `0527eec`, com documentação de revisão ainda não commitada. Os controles e ações principais foram inspecionados no código; nenhuma rota foi validada em navegador nesta revisão.
...
- **Validada em navegador**: apenas quando houver execução registrada; nenhuma está nesta classe por enquanto.
...
| `/clientes/[clienteId]/ajustes/acervo` | [Configuração, acesso e demais telas](06-configuracao-acesso.md) | Inspecionada no código |
| `/clientes/[clienteId]/ajustes/anuncios` | [Transmissões e conexões](07-transmissoes-conexoes.md) | Inspecionada no código |
| `/clientes/[clienteId]/ajustes/chaves` | [Transmissões e conexões](07-transmissoes-conexoes.md) | Inspecionada no código |
| `/clientes/[clienteId]/ajustes/contexto` | [Configuração, acesso e demais telas](06-configuracao-acesso.md) | Inspecionada no código |
| `/clientes/[clienteId]/ajustes/equipe` | [Configuração, acesso e demais telas](06-configuracao-acesso.md) | Inspecionada no código |
| `/clientes/[clienteId]/ajustes/etiquetas` | [Configuração, acesso e demais telas](06-configuracao-acesso.md) | Inspecionada no código |
| `/clientes/[clienteId]/ajustes/horario` | [Configuração, acesso e demais telas](06-configuracao-acesso.md) | Inspecionada no código |
| `/clientes/[clienteId]/ajustes/instagram` | [Transmissões e conexões](07-transmissoes-conexoes.md) | Inspecionada no código |
| `/clientes/[clienteId]/ajustes/integracoes/magento` | [Transmissões e conexões](07-transmissoes-conexoes.md) | Inspecionada no código |
| `/clientes/[clienteId]/ajustes/integracoes` | [Transmissões e conexões](07-transmissoes-conexoes.md) | Inspecionada no código |
| `/clientes/[clienteId]/ajustes/negocio` | [Configuração, acesso e demais telas](06-configuracao-acesso.md) | Inspecionada no código |
| `/clientes/[clienteId]/ajustes` | [Configuração, acesso e demais telas](06-configuracao-acesso.md) | Inspecionada no código |
| `/clientes/[clienteId]/ajustes/plano` | [Configuração, acesso e demais telas](06-configuracao-acesso.md) | Inspecionada no código |
| `/clientes/[clienteId]/ajustes/produtos` | [Configuração, acesso e demais telas](06-configuracao-acesso.md) | Inspecionada no código |
| `/clientes/[clienteId]/ajustes/recursos` | [Configuração, acesso e demais telas](06-configuracao-acesso.md) | Inspecionada no código |
| `/clientes/[clienteId]/ajustes/respostas-rapidas` | [Configuração, acesso e demais telas](06-configuracao-acesso.md) | Inspecionada no código |
| `/clientes/[clienteId]/ajustes/retomada` | [Configuração, acesso e demais telas](06-configuracao-acesso.md) | Redirecionamento conferido |
| `/clientes/[clienteId]/ajustes/whatsapp` | [Transmissões e conexões](07-transmissoes-conexoes.md) | Inspecionada no código |
| `/clientes/[clienteId]/atividades` | [Atendimento e CRM](05-atendimento-crm.md) | Inspecionada no código |
| `/clientes/[clienteId]/configurar` | [Configuração, acesso e demais telas](06-configuracao-acesso.md) | Inspecionada no código |
| `/clientes/[clienteId]/favoritas` | [Atendimento e CRM](05-atendimento-crm.md) | Inspecionada no código |
| `/clientes/[clienteId]/fluxos/[fluxoId]` | [Automações e editor](04-automacoes.md) | Inspecionada no código |
| `/clientes/[clienteId]/fluxos` | [Automações e editor](04-automacoes.md) | Inspecionada no código |
| `/clientes/[clienteId]/inbox` | [Atendimento e CRM](05-atendimento-crm.md) | Inspecionada no código |
| `/clientes/[clienteId]/leads/[contatoId]` | [Atendimento e CRM](05-atendimento-crm.md) | Inspecionada no código |
| `/clientes/[clienteId]/leads/importar` | [Atendimento e CRM](05-atendimento-crm.md) | Inspecionada no código |
| `/clientes/[clienteId]/leads` | [Atendimento e CRM](05-atendimento-crm.md) | Inspecionada no código |
| `/clientes/[clienteId]/leads/segmentos` | [Atendimento e CRM](05-atendimento-crm.md) | Inspecionada no código |
| `/clientes/[clienteId]` | [Configuração, acesso e demais telas](06-configuracao-acesso.md) | Inspecionada no código |
| `/clientes/[clienteId]/quadros/atividades` | [Atendimento e CRM](05-atendimento-crm.md) | Redirecionamento conferido |
| `/clientes/[clienteId]/quadros` | [Atendimento e CRM](05-atendimento-crm.md) | Inspecionada no código |
| `/clientes/[clienteId]/respostas` | [Atendimento e CRM](05-atendimento-crm.md) | Inspecionada no código |
| `/clientes/[clienteId]/transmissoes` | [Transmissões e conexões](07-transmissoes-conexoes.md) | Inspecionada no código |
